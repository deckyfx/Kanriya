...
namespace Kanriya.Server.Migrations
{
    ...
    [Migration("20250826121102_AddBrandUserCascadeDelete")]
    partial class AddBrandUserCascadeDelete
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Kanriya.Server.Data.Brand", b =>
                {
                    b.HasOne("Kanriya.Server.Data.User", "Owner")
                        .WithMany("OwnedBrands")
                        .HasForeignKey("OwnerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_brands_users_owner_id");
